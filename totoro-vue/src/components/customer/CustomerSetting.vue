<template>
    <div>
        ...
        <van-cell-group >
            <van-cell  >
                <p slot="title" style="font-size: 1.2rem; margin-top: 4rem;margin-left: 3rem">
                    用户名
                </p>>
                <p slot="default" style="font-size: 1.2rem;margin-top: 3.5rem;margin-right: 3rem">{{username}}</p>
            </van-cell>
            <van-cell  >
            <p slot="title" style="font-size: 1.2rem; margin-top: 1rem;margin-left: 3rem">
                邮 箱
            </p>>
            <p slot="default" style="font-size: 1.2rem;margin-top: .5rem;margin-right: 3rem">{{email}}</p>
            </van-cell>
            <van-cell  >
                <p slot="title" style="font-size: 1.2rem; margin-top: 1rem;margin-left: 3rem">
                    年 龄
                </p>>
                <p slot="default" style="font-size: 1.2rem;margin-top: .5rem;margin-right: 3rem">{{age}}</p>
            </van-cell>
            <van-cell  >
                <p slot="title" style="font-size: 1.2rem; margin-top: 1rem;margin-left: 3rem">
                    性别
                </p>>
                <p slot="default" style="font-size: 1.2rem;margin-top: .5rem;margin-right: 3rem">{{sex === '1'? '男': '女'}}</p>
            </van-cell>
        ...
        <van-popup v-model="show" round closeable position="bottom">
            <van-cell-group style="line-height: 60px;margin-top: 2rem;margin-left: 1rem">
                ...
                <van-field
                        ...
                        style="line-height: 3rem;font-size: 1.2rem;margin-left: 2rem"
                />
                <label style="float: left; width:100px;margin-left: 2.5rem;font-size: 1.2rem;line-height: 3rem; padding-top: .4rem"> 年龄: </label>
        ...
        <van-dialog
                style="width: 15rem; height: 5rem; font-size: 2rem"
                v-model="dialogShow"
                show-cancel-button
                show-confirm-button
                @confirm="confirmLogout"
        >
            <p slot="default" style="font-size: .7rem; text-align: center; padding-top: .7rem">确认退出登录吗？</p>
        </van-dialog>
    </div>
</template>
